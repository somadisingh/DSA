...
Input
In a single line you are given two integers M and N — board 
sizes in squares (1 ≤ M ≤ N ≤ 16).
...
/*
Logic: multiply M & N then divide by 2x1. The quotient is the number
of maximum possible dominos allowed in that MxN board.
*/
